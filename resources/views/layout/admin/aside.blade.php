<aside id="left-panel" class="left-panel">
	<nav class="navbar navbar-expand-sm navbar-default">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="./"><img src="/img/logo-vector.png" alt="Logo"></a>
		</div>
		...
		<div id="main-menu" class="main-menu collapse navbar-collapse">
			<ul class="nav navbar-nav">
				...
				<li class="menu-item-has-children dropdown">
					...
					<ul class="sub-menu children dropdown-menu">
						<li><i class="menu-icon fa fa-th"></i><a href="forms-basic.html">Ver Marcas</a></li>
						<li><i class="menu-icon fa fa-th"></i><a href="forms-advanced.html">Nueva Marca</a></li>
					</ul>
				</li>
				<li class="menu-item-has-children dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Cupones</a>
					<ul class="sub-menu children dropdown-menu">
						<li><i class="menu-icon fa fa-th"></i><a href="forms-basic.html">Ver Cupones</a></li>
						<li><i class="menu-icon fa fa-th"></i><a href="forms-advanced.html">Nuevo Cupon</a></li>
					</ul>
				</li>
			</ul>
		</div><!-- /.navbar-collapse -->
