                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active"><a href="/adm/{{ $route }}/create">Editar {{ $section }}</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form action="/adm/{{ $route }}/{{ $model->id }}/update" method="POST"  enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="card-body card-block">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" name="name" value="{{ $model->name }}" placeholder="Nombre de la marca *" required>
                                        </div>
